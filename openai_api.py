...
def _stable_json_key(obj):
    return json.dumps(obj, sort_keys=True, ensure_ascii=False)

def apply_arg_defaults(generation_kwargs):
    generation_kwargs.setdefault("n", 1)
...
class OpenAIClient:
    ...
    def get_responses(self, prompts: List[str], model: str, system_message: str, generation_kwargs: dict, batch_api: bool):
        ...
        return self.get_batched_responses(prompts, model, 15, generation_kwargs, system_message, show_progress=True)
